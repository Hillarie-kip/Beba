...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Paper.init(this);
        String email = Paper.book().read(Constants.Params.RIDER_ID_KEY);
        String password =Paper.book().read(Constants.Params.STATUS_KEY);
        ...
        LogIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(CheckEditText){
                    ...
                    Paper.book().write(Constants.Params.RIDER_ID_KEY, DriverId.getText().toString());
                    Paper.book().write(Constants.Params.STATUS_KEY, Status.getText().toString());
                }
                else {
                    StyleableToast.makeText(LoginActivity.this, "Please Fill all fields", Toast.LENGTH_SHORT, R.style.error).show();
