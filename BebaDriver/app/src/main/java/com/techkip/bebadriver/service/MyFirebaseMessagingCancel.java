...
import com.techkip.bebadriver.CustomerCallCancel;
...
public class MyFirebaseMessagingCancel extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData() != null) {
            ...
            Intent intent = new Intent(getBaseContext(), CustomerCallCancel.class);
