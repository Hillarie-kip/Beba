...
public class CustomerCallCancel extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener {
        ...
        btnAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TxtDistance.equals("Distance")) {
                    Toast.makeText(CustomerCallCancel.this, "wait to load info", Toast.LENGTH_SHORT).show();

                } else {
                    Intent intent = new Intent(CustomerCallCancel.this, DriverTracking.class);
        ...
        countDownTimer = new CountDownTimer(timeCountInMilliSeconds, 1000) {
            ...
            public void onFinish() {
                ...
                if (!TextUtils.isEmpty(customerId))
                    ...
                    Toast.makeText(CustomerCallCancel.this, "Customer Must have an ID", Toast.LENGTH_SHORT).show();
                ...
                .enqueue(new Callback<FCMResponse>() {
                    ...
                    public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                        if (response.body().success == 1) {
                            Toast.makeText(CustomerCallCancel.this, "Cancelled", Toast.LENGTH_SHORT).show();
                            finish();
                        }
    ...
    private void acceptBooking(String customerId) {
        ...
        mFCMService.sendMessage(dataMessage)
                .enqueue(new Callback<FCMResponse>() {
                    ...
                    public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                        if (response.body().success == 1) {
                            Toast.makeText(CustomerCallCancel.this, "you have accepted request", Toast.LENGTH_SHORT).show();
                            finish();
                        }
            ...
            mService.getPath(requestApi)
                    .enqueue(new Callback<String>() {
                        ...
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(CustomerCallCancel.this, "Google Map Error :" + t.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            try {
                                ...
                                new CustomerCallCancel.ParseTask().execute(response.body().toString());
                        ...
                        @Override
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(CustomerCallCancel.this, "Error : " + t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private class ParseTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(CustomerCallCancel.this);
